...
public class ChatterbookController {
    ...
    public User getUserByUsername(@PathVariable String username) {
        ...
        throw new ControllerExceptionHandler("User not found with username: " + username);
    }

    //    Get list of chatterPosts for a user by username
    //    Http method Get
    ...
    public List<ChatterPost> getChatterPostsByUsername(@PathVariable String username) {
        ...
        throw new ControllerExceptionHandler("Posts not found with username: " +username);
    }
}
